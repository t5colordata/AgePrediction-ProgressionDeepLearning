...
graph.add_node(Convolution2D(64, 3, 3, border_mode='valid',activation='relu'),name='conv_2',input='conv2_1')
graph.add_node(Convolution2D(64, 3, 3, border_mode='valid',activation='relu'),name='conv1_2',input='conv2_2')
