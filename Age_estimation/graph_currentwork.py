...
graph.add_shared_node(Convolution2D(256,3,3,activation='relu',W_regularizer=l1(0.01),border_mode="valid"),name='combined_layer_1',inputs=['conv1_6','conv2_6'],merge_mode='ave')
...
graph.compile('rmsprop',{'output1':'binary_crossentropy'})
